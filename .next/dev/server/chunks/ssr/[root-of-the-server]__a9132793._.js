...
function AuthProvider({ children }) {
    ...
    async function loadSession() {
        try {
            const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSession"])();
            setUser(session);
        } catch (error) {
    ...
    async function signIn() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithDiscord"])();
    }
    async function signOut() {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signOut"])();
        setUser(null);
    }
    const value = {
        user,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9132793._.js.map