...
"[project]/src/utils/cardData.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/packArt.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cardData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/cardData.js [app-client] (ecmascript)");
        ...
        if (response.ok) {
            ...
            if (data.data && data.data.sets) {
                return data.data.sets.map((set)=>({
                        ...set,
                        imageUrl: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$packArt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPackArtUrl"])(set.code)
                    }));
            }
        }
    } catch (error) {
...
async function fetchSetCards(setCode) {
    ...
    try {
        const localCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cardData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCardsBySet"])(setCode);
...
"[project]/src/utils/cardCache.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function initializeCardCache() {
    ...
    try {
        const allCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cardData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllCards"])();
        ...
        sets.forEach((setCode)=>{
            const setCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cardData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCardsBySet"])(setCode);
...
"[project]/src/utils/setConfigs/SOR.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/SHD.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/TWI.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/JTL.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/LOF.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/SEC.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/setConfigs/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SOR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/SOR.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SHD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/SHD.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$TWI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/TWI.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$JTL$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/JTL.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$LOF$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/LOF.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SEC$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/setConfigs/SEC.js [app-client] (ecmascript)");
;
;
;
;
...
;
const SET_CONFIGS = {
    'SOR': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SOR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOR_CONFIG"],
    'SHD': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SHD$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHD_CONFIG"],
    'TWI': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$TWI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TWI_CONFIG"],
    'JTL': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$JTL$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JTL_CONFIG"],
    'LOF': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$LOF$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOF_CONFIG"],
    'SEC': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$SEC$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEC_CONFIG"]
};
function getSetConfig(setCode) {
...
"[project]/src/utils/rarityConfig.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function getSetDistributionPeriod(setCode) {
...
function allowsSpecialInFoil(setCode) {
    const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSetConfig"])(setCode);
...
"[project]/src/utils/boosterPack.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateBoosterPack(cards, setCode) {
    ...
    const setConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$setConfigs$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSetConfig"])(setCode);
    if (!setConfig) {
        console.warn(`No configuration found for set ${setCode}, using defaults`);
    }
    // Get distribution configuration for this set
    const distribution = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$rarityConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDistributionForSet"])(setCode);
    ...
    const packShouldHaveHyperspace = isPreLawlessTime ? Math.random() < distribution.hyperspace.inStandardPack // 66.7% for Pre-A Lawless Time
 ...
 */ function rollHyperspace(distribution) {
    ...
    if (distribution === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$rarityConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RARITY_DISTRIBUTIONS"][__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$rarityConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DISTRIBUTION_PERIODS"].A_LAWLESS_TIME_ONWARD]) {
...
"[project]/src/utils/textParser.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseCardText(text) {
    ...
    lines.forEach((line, lineIndex)=>{
        if (lineIndex > 0) {
            result.push(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, `br-${lineIndex}`, false, {
                fileName: "[project]/src/utils/textParser.jsx",
                lineNumber: 42,
                columnNumber: 19
            }, this));
...
"[project]/src/utils/aspectColors.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_utils_fada3149._.js.map