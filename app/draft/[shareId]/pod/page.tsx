...
export default function PodPage({ params }: PageProps) {
  ...
  // Load own pool data for export functions
  useEffect(() => {
  ...
  const getDeckData = () => {
    ...
    const allCards = getCachedCards(myPool.setCode) || []
  ...
  return (
    <div className="pod-page">
      ...
      <div className="pod-content">
        ...
        {/* Owner view: Pod Status — 2-column player grid by seat */}
        {isHost && (
            ...
            <div className="pod-player-grid">
              {[...players].sort((a, b) => a.seatNumber - b.seatNumber).map((player) => (
                <div key={player.id} className="pod-player-row">
                  ...
                  {player.isReady && playerPoolMap.get(player.id) && (
                    <button
        ...
        <div className="pod-discord-banner">
          ...
          <a href="https://discord.gg/u6fkdDzWqF" target="_blank" rel="noopener noreferrer" className="pod-discord-link">
