  ...
  return (
    <div className="solo-page">
      <div className="solo-container">
        ...
        <h1>Solo Play</h1>
        <p className="solo-subtitle">Practice on your own or build a limited deck for later</p>

        <div className="solo-modes-grid solo-primary">
          <button
          ...
          >
            ...
            <div className="format-mode-card-content">
              <h3>Sealed</h3>
              <p>Open 6 packs, build a deck</p>
            </div>
          </button>

          <button
            className="format-mode-card art-event"
            onClick={() => router.push('/solo/draft')}
          >
            <div
              className="format-mode-card-art"
            ...
            <div className="format-mode-card-content">
              <h3>Draft</h3>
              <p>Draft against bots</p>
            </div>
          </button>
        </div>

        <div className="solo-modes-grid solo-secondary">
          <button
            className="format-mode-card art-event glow-red"
            onClick={() => router.push('/solo/chaos-draft')}
          >
            <div
              className="format-mode-card-art"
