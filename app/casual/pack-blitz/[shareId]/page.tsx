...
export default function PackBlitzPlayPage() {
  ...
  return (
    <div className="pack-blitz-play-page">
      <div className="pack-blitz-play-container">
        ...
        <div className="pack-blitz-leader-base">
          <div className="leader-section">
            <h3>Leader</h3>
            <div className="card-display">
              <Card card={poolData.leader} />
            </div>
          </div>
          <div className="base-section">
            <h3>Base</h3>
            <div className="card-display">
              <Card card={poolData.base} />
            </div>
          </div>
        </div>

        <div className="pack-blitz-deck-section">
        ...
        <div className="pack-blitz-all-cards">
          <h3>All Cards in Pack</h3>
